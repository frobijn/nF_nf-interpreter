...
HRESULT Library_nf_runtime_isr_gpio_nanoFramework_Runtime_ISR_GpioPin::DisposeNativeDataBus___VOID__I4( CLR_RT_StackFrame &stack )
{
    NANOCLR_HEADER();
...
HRESULT Library_nf_runtime_isr_gpio_nanoFramework_Runtime_ISR_GpioPin::InitialiseNativeDataBus___VOID__I4__BOOLEAN__SystemDeviceGpioGpioPin( CLR_RT_StackFrame &stack )
{
    NANOCLR_HEADER();
